                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="read-more-btn">
                                                <span class="rbt-btn-link">7 Courses<i class="feather-arrow-right"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="single-slide">
                                <a class="rbt-cat-box rbt-cat-box-1 text-center" href="#">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <h5 class="title">Software Training</h5>
                                            <div class="read-more-btn">
                                                <span class="rbt-btn-link">3 Courses <i class="feather-arrow-right"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="rbt-course-tab-button-wrap">
                            <ul class="rbt-course-tab-button nav nav-tabs" id="rbt-myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="active" id="development-tab" data-bs-toggle="tab" data-bs-target="#development" type="button" role="tab" aria-controls="development" aria-selected="true"><span class="filter-text">Web & Software Dev</span></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button id="ui_ux-tab" data-bs-toggle="tab" data-bs-target="#ui-ux" type="button" role="tab" aria-controls="ui-ux" aria-selected="false"><span class="filter-text">AI & Data Science</span></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button id="marketing-tab" data-bs-toggle="tab" data-bs-target="#marketing" type="button" role="tab" aria-controls="marketing" aria-selected="false"><span class="filter-text">Cybersecurity & DevOps</span></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button id="business-tab" data-bs-toggle="tab" data-bs-target="#business" type="button" role="tab" aria-controls="business" aria-selected="false"><span class="filter-text">Cloud & Automation</span></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button id="language-tab" data-bs-toggle="tab" data-bs-target="#language" type="button" role="tab" aria-controls="language" aria-selected="false"><span class="filter-text">IoT & Embedded</span></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button id="language1-tab" data-bs-toggle="tab" data-bs-target="#language1" type="button" role="tab" aria-controls="language1" aria-selected="false"><span class="filter-text">BI & Databases</span></button>
                                </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tab-content" id="rbt-myTabContent">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="rbt-card variation-04 rbt-hover">
                                            ...
                                            <div class="rbt-card-body">
                                                ...
                                                <h4 class="rbt-card-title"><a href="course-details.html">Full Stack Development</a>
                                                </h4>
                                                <p class="rbt-card-text">Learn front-end and back-end technologies to build complete web applications.</p>
                            ...
                            <div class="tab-pane fade" id="language1" role="tabpanel" aria-labelledby="language1-tab">
                                <div class="row g-5">
