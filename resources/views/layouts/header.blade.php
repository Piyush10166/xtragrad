<!DOCTYPE html><html lang="en"><head>
    ...
    <title>Xtragrad</title>
    <meta name="robots" content="noindex, follow">
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="images/xtragrad-favicon.png">
                ...
                <div class="mainbar-row rbt-navigation-center align-items-center">
                    <div class="header-left">
                        ...
                        <div class="logo d-none logo-light">
                            <a href="index.html">
                                <img src="images/dark-logo.png" alt="Education Logo Images">
                            </a>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mega-top-banner">
                                                        <div class="content">
                                                            <h4 class="title">Xtragrad hub</h4>
       ...
       <div class="popup-mobile-menu">
        <div class="inner-wrapper">
            <div class="inner-top">
                ...
                <p class="description">Xtragrad Professional & Lifelong Learning</p>
                <ul class="navbar-top-left rbt-information-list justify-content-start">
                    <li>
                        <a href="mailto:hello@example.com"><i class="feather-mail"></i>support@xtragrad.in</a>
                    </li>
                    <li>
                        <a href="#"><i class="feather-phone"></i>+91 93478-39951</a>
                    </li>
                </ul>
            </div>
